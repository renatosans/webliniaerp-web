...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="RelatorioTotalVendasVendedorController" ng-cloak>
	<!-- Overlay Div -->
	...
	<script src="js/angular-controller/relatorio-total-vendas-vendedor-controller.js"></script>
