app.controller('RelatorioVendasCategoriaCtrl', function($scope, $http, $window, UserService, EmpreendimentoService) {
	var ng 				= $scope;
		aj 				= $http;
	...
	ng.loadVendas = function() {
		...
		queryString += "&hraInicial="+hraInicial+"&hraFinal="+hraFinal;
