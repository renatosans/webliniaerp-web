...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="RelatorioVendasHoraAHoraController" ng-init="setDateInit()" ng-cloak>
	<!-- Overlay Div -->
				...
				<div class="clearfix">
					<div class="pull-left">
						...
						<div class="pull-left m-left-sm">
							<h3 class="m-bottom-xs m-top-xs">Relatório Vendas Hora a Hora</h3>
				...
				<div class="panel panel-default hidden-print" style="margin-top: 15px;">
					...
					<div class="panel-footer clearfix">
						<div class="pull-right">
							<button type="button" class="btn btn-sm btn-primary" ng-click="loadVendas()">
