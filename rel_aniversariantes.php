...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="RelatorioAniversariantes" ng-cloak>
			...
			<div class="padding-md">
				<div class="clearfix">
					<div class="pull-left">
						...
						<div class="pull-left m-left-sm">
							<h3 class="m-bottom-xs m-top-xs">Relatório de Aniversáriantes</h3>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table id="data" class="table table-bordered table-hover table-striped table-condensed" ng-if="(aniversariantes_mes)">
							<thead>
								<tr>
									<th class="text-center">Nome</th>
									<th width="200" class="text-center">Data Nascimento</th>
							...
							<tbody>
								<tr ng-if="aniversariantes_mes.length == 0">
									<td class="text-center" colspan="6">
										<i class="fa fa-refresh fa-spin"></i> Aguarde, carregando itens...
									</td>
								</tr>
								<tr ng-repeat="item in aniversariantes_mes">
									<td class="text-center">{{ item.nome }}</td>
									<td class="text-center">{{ item.dta_nacimento | dateFormat:'date' }}</td>
									<td class="text-center">{{ item.apelido }}</td>
	...
	<script src="js/angular-controller/rel_aniversariantes-controller.js"></script>
