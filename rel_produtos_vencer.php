...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="RelatorioProdutosVencerController" ng-cloak>
	<!-- Overlay Div -->
				...
				<div class="clearfix">
					<div class="pull-left">
						...
						<div class="pull-left m-left-sm">
							<h3 class="m-bottom-xs m-top-xs">Relatório de Produtos à Vencer</h3>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-lg-2">
									<div class="form-group">
										<label class="control-label">Tempo (em dias)</label>
										<select class="form-control" ng-model="tempoAvalicao">
								...
								<div class="col-lg-2">
									<div class="form-group">
										...
										<select class="form-control" ng-model="itensPagina">
	...
	<script src="js/angular-controller/relatorio_produtos_vencer-controller.js"></script>
