							...
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<div class="input-group">
											<input stardate="{{ stardate_dtaInicial }}" readonly="readonly" style="background:#FFF;cursor:pointer" type="text" id="dtaInicial" class="datepicker form-control">
								...
								<div class="col-sm-2">
									<div class="form-group">
										...
										<div class="input-group">
											<input stardate="{{ stardate_dtaFinal }}" readonly="readonly" style="background:#FFF;cursor:pointer" type="text" id="dtaFinal" class="datepicker form-control">
