...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="ImportadoresController" ng-cloak>
  	<!-- Overlay Div -->
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active"><i class="fa fa-plane"></i> Importadores</li>
				</ul>
			</div><!-- breadcrumb -->

			<div class="main-header clearfix">
				<div class="page-title">
					<h3 class="no-margin"><i class="fa fa-plane"></i> Importadores</h3>
					<br/>
					<a class="btn btn-info" id="btn-novo" ng-disabled="editing" ng-click="showBoxNovo()"><i class="fa fa-plus-circle"></i> Novo Importador</a>
				</div><!-- /page-title -->
			</div><!-- /main-header -->
			...
			<div class="padding-md">
				...
				<div class="panel panel-default" id="box-novo" style="display:none">
					<div class="panel-heading"><i class="fa fa-plus-circle"></i> Novo Importador</div>

					<div class="panel-body">
						<form class="form-horizontal" role="form">
							<div id="nome_importador" class="form-group">
								<label for="descricao" class="col-sm-1 control-label">Descrição</label>
								<div class="col-sm-11">
									<input type="text" class="form-control" id="descricao" ng-model="importador.nome_importador">
								</div>
							</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading"><i class="fa fa-tasks"></i> Importadores Cadastrados</div>
					...
					<div class="panel-body">
						...
						<table class="table table-bordered table-condensed table-striped table-hover">
							...
							<tbody>
								<tr ng-repeat="item in importadores">
	...
	<script src="js/angular-controller/importadores-controller.js"></script>
