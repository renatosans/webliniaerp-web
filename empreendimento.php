...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="EmpreendimentoController" ng-cloak>
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active"><i class="fa fa-building-o"></i> Empreendimento</li>
				</ul>
			</div><!-- breadcrumb -->

			<div class="main-header clearfix">
				<div class="page-title">
					<h3 class="no-margin"><i class="fa fa-building-o"></i> Empreendimento</h3>
					<br/>
			...
			<div class="padding-md">
				...
				<div class="panel panel-default">
					<div  class="panel-heading">{{ userLogged.nome_empreendimento }}</div>
	...
	<script src="js/angular-controller/empreendimento-controller.js?version=<?php  echo date("dmY-His", filemtime("js/angular-controller/empreendimento-controller.js")) ?>"></script>
