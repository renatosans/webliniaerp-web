...
<html lang="en" ng-app="HageERP">
  ...
  <body class="overflow-hidden" ng-controller="RelatorioProdutosVencidosController" ng-cloak>
	<!-- Overlay Div -->
				...
				<div class="panel panel-default">
					<div class="panel-footer clearfix hidden-print">
						<div class="pull-right">
							<button class="btn btn-sm btn-success" id="invoicePrint"><i class="fa fa-print"></i> Imprimir</button>
				...
				<table id="data" class="table table-bordered table-hover table-striped table-condensed">
					...
					<tbody>
						<tr ng-repeat="item in itens">
							...
							<td class="text-center">{{ item.qtd_dias_vencido }}</td>
						</tr>
					</tbody>
				</table>
			</div><!-- /.padding20 -->
	...
	<script src="js/angular-controller/relatorio_produtos_vencidos-controller.js"></script>
