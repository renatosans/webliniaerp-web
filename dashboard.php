						...
						<div class="form-group">
							<div class="form-group">
								<label class="label-radio inline">
									<input ng-model="flg_tipo_map_hora_hora"  name="flg_tipo_map_hora_hora" value="1" type="radio" class="inline-radio" ng-change="loadVendasHoraHoraSemanal(null,null)">
									<span class="custom-radio"></span>
									<span>Quantidade</span>
								</label>
								<label class="label-radio inline">
									<input ng-model="flg_tipo_map_hora_hora"  name="flg_tipo_map_hora_hora" value="0" type="radio" class="inline-radio" ng-change="loadVendasHoraHoraSemanal(null,null)">
									<span class="custom-radio"></span>
									<span>Valor</span>
								</label>
							</div>
