							...
							<div class="tab-pane fade" id="integracoes">
								<div class="panel-tab clearfix">
									<ul class="tab-bar">
                                        ...
                                        <li>
                                            <a href="#bankse" data-toggle="tab">
                                                <i class="fa fa-usd"></i> Bankse
                                            </a>
                                        </li>
									</ul>
								</div>
								...
								<div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in" id="bankse">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group" style="float: left;">
                                                        <label class="label-radio inline">
                                                            <input ng-model="configuracoes.bankse_environment" value="development" name="bankse_environment" type="radio" class="inline-radio">
                                                            <span class="custom-radio"></span>
                                                            <span>Desenvolvimento</span>
                                                        </label>
                                                        <label class="label-radio inline">
                                                            <input ng-model="configuracoes.bankse_environment" value="production" name="bankse_environment" type="radio" class="inline-radio">
                                                            <span class="custom-radio"></span>
                                                            <span>Produção</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <div class="form-group" id="bankse_username_development">
                                                    <label class="control-label">Username</label>
                                                    <input ng-model="configuracoes.bankse_username_development"
                                                           type="text" class="form-control input-sm parsley-validated">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group" id="bankse_password_development">
                                                    <label class="control-label">Password</label>
                                                    <input ng-model="configuracoes.bankse_password_development"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <div class="form-group" id="bankse_username_production">
                                                    <label class="control-label">Username </label>
                                                    <input ng-model="configuracoes.bankse_username_production"
                                                           type="text" class="form-control input-sm parsley-validated">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="form-group" id="bankse_password_production">
                                                    <label class="control-label">Password</label>
                                                    <input ng-model="configuracoes.bankse_password_production"
                                                           type="password" class="form-control input-sm parsley-validated">
                                                </div>
                                            </div>
                                        </div>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="pull-right">
											<button data-loading-text="<i class='fa fa-refresh fa-spin'></i> Aguarde, salvando..." ng-click="salvarConfigPrestaShop($event);saveBankseSettings($event);" type="submit" class="btn btn-success btn-sm">
												<i class="fa fa-save"></i> Salvar
											</button>
										</div>
									</div>
