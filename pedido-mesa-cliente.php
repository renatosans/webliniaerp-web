...
<body class="overflow-hidden" ng-controller="PedidoMesaClienteController" ng-cloak>
  	<!-- Overlay Div -->
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					...
					<li class="active" ng-click="showAvaliableKitchens()">
						<i class="fa fa-table"></i> Pedido de Cliente na Mesa
					</li>
				</ul>
			</div><!-- breadcrumb -->
			...
			<div class="main-header clearfix hidden-xs">
				<div class="page-title">
					<h3 class="no-margin"><i class="fa fa-table"></i> Pedido de Cliente na Mesa</h3>
				</div><!-- /page-title -->
			</div><!-- /main-header -->
			...
			<div class="mesa-container">
				...
				<div class="panel panel-default"> <!-- SE ESTIVER NA VISUALIZAÇÃO DA MESA OU COMANDA TROCAR POR 'panel-warning' --> 
									...
									<div class="row">
										<div class="col-xs-offset-3 col-xs-6">
											<div class="form-group has-warning">
												...
												<input class="form-control input-lg text-center" ng-model="num_comanda" placeholder="Nº Comanda">
											</div>
										</div>
									</div>
					...
					<div class="panel-body" ng-show="layout.escTipoProduto">
						<fieldset>
	...
	<script src="js/angular-controller/pedido-mesa-cliente_controller.js?<?php echo filemtime('js/angular-controller/pedido-mesa-cliente_controller.js')?>"></script>
